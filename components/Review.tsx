  ...
  return (
    <>
      {reviews.map((review, idx) => (
        <div
          key={idx}
          className="group relative overflow-hidden rounded-2xl bg-black/40 backdrop-blur-xl border border-[#FCDF59]/10 p-6 sm:p-8 flex flex-col h-full transition-all duration-500 hover:border-[#FCDF59]/30 hover:bg-black/50"
        >
